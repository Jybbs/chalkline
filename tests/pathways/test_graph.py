...
class TestCareerPathwayGraph:
    ...
    def test_density_cap(self, pathway_graph: CareerPathwayGraph):
        """
        Edge count stays within the `max_density` ceiling.
        """
        n = pathway_graph.size
        max_edges = int(pathway_graph.max_density * n * (n - 1) / 2)
        assert pathway_graph.graph.number_of_edges() <= max_edges

    def test_edge_attrs_complete(self, pathway_graph: CareerPathwayGraph):
        """
    ...
    def test_edge_job_zone_order(self, pathway_graph: CareerPathwayGraph):
        """
    ...
    def test_longest_path_weight(self, pathway_graph: CareerPathwayGraph):
        """
